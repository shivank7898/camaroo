      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="flex-1 justify-center px-6 pb-10">
          <View className="p-8 rounded-2xl border border-white/20 bg-white/5 shadow-2xl relative overflow-hidden">
            ...
            {/* Inputs Container (Alternating Slides) */}
            <View className="gap-4 mb-6">
              <Animated.View style={{ transform: [{ translateX: slideAnimRight1 }], opacity: fadeAnim }}>
                <Input label="Email" placeholder="your@email.com" keyboardType="email-address" autoCapitalize="none" />
              </Animated.View>
              <Animated.View style={{ transform: [{ translateX: slideAnimLeft1 }], opacity: fadeAnim }}>
                <Input label="Password" placeholder="••••••••" secureTextEntry />
              </Animated.View>
            </View>

            <Animated.View style={{ transform: [{ translateX: slideAnimRight1 }], opacity: fadeAnim }}>
              <Text className="text-right font-outfit text-secondary text-sm mb-8">
                Forgot password?
              </Text>
            </Animated.View>

            {/* Sign In Button (Slides bottom-to-top) */}
            <Animated.View style={{ transform: [{ translateY: btnSlideAnim }], opacity: btnFadeAnim }}>
              <TouchableOpacity activeOpacity={0.85} onPress={handleLogin}>
                ...
                >
                  <Text className="font-outfit-bold text-white text-lg">Sign In</Text>
                </LinearGradient>
              </TouchableOpacity>
            </Animated.View>
